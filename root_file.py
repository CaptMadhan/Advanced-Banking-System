    ...
    def customer_signin_window(cust_id_):
        ...
        def mini_statement_f():
            ...
            for i in range(len(x)):
                ...
                var=''
            i=0
            Label(mini_statement,text ="\tACCOUNT NO\tTRANS ID   \tACTIVITY \tACTIVITY DATETIME\t",font ="none 15",bg ="#fdb9b9", borderwidth=2, relief="ridge",pady=10,padx=10).grid(row=0,column=0,pady=10,padx=0)
